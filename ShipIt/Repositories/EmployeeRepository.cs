...
namespace ShipIt.Repositories
{
    ...
    public class EmployeeRepository : RepositoryBase, IEmployeeRepository
    {
        ...
        public EmployeeDataModel GetEmployeeByName(string name)
        {
            ...
            return RunSingleGetQuery(sql, reader => new EmployeeDataModel(reader),noProductWithIdErrorMessage, parameter);
        }
        ...
        public EmployeeDataModel GetOperationsManager(int warehouseId)
        {
            ...
            string noProductWithIdErrorMessage =
                string.Format("No employees found with Warehouse Id: {0}", warehouseId);
            return RunSingleGetQuery(sql, reader => new EmployeeDataModel(reader), noProductWithIdErrorMessage, parameters);
        }
        ...
        public string AddEmployee(Employee employee)
        {
            ...
            string CouldNotAddEmloyee = 
                string.Format("Could Not Add Employee");
